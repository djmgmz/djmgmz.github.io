...
const projects = [
  {
    ...
    images: [
      '/src/assets/stsweng/stsweng1.png',
      '/src/assets/stsweng/stsweng2.png',
      '/src/assets/stsweng/stsweng3.png',
    ],
  },
  {
    id: 2,
    ...
    techStack: ['React', 'TypeScript', 'Node.js', 'Express', 'MongoDB'],
    images: [
      '/src/assets/slipstream/slipstream1.png',
      '/src/assets/slipstream/slipstream2.jpeg',
      '/src/assets/slipstream/slipstream3.png',
      '/src/assets/slipstream/slipstream4.jpeg',
      '/src/assets/slipstream/slipstream5.png',
      '/src/assets/slipstream/slipstream6.png',
    ],
  },
  {
    id: 3,
    ...
    images: [
      '/src/assets/quiver/quiver1.png',
      '/src/assets/quiver/quiver2.png',
      '/src/assets/quiver/quiver3.png',
      '/src/assets/quiver/quiver4.png',
      '/src/assets/quiver/quiver5.png',
      '/src/assets/quiver/quiver6.png',
      '/src/assets/quiver/quiver7.png',
      '/src/assets/quiver/quiver8.png',
    ],
  },
  {
    id: 4,
    ...
    images: [
      '/src/assets/studentemployability/studentemployability1.png',
      '/src/assets/studentemployability/studentemployability2.png',
      '/src/assets/studentemployability/studentemployability3.png',
      '/src/assets/studentemployability/studentemployability4.png',
      '/src/assets/studentemployability/studentemployability5.png',
    ],
  },
]
